...
<?php if ( get_theme_mod('lnx_primary_content_color') ) : ?>
    #main-content p {
        color: <?php echo get_theme_mod('lnx_primary_content_color'); ?>
    }
...
.navbar-toggle .icon-bar {
    background-color: <?php echo get_theme_mod('lnx_header_background_color'); ?>;
}

.level-1 .current_page_item a,
.level-1 .current-page-ancestor a {
    color: <?php echo get_theme_mod('lnx_header_background_color'); ?>;
}
...
<?php if ( get_theme_mod('lnx_header_accent_color') ) : ?>
    .level-1 .current_page_item a,
    .level-1 .current-page-ancestor a {
        background: <?php echo get_theme_mod('lnx_header_accent_color'); ?>;
    }
<?php endif; ?>
...
.navbar-toggle {
    background-color: <?php echo get_theme_mod('lnx_header_menu_color'); ?>;;
    border-color: <?php echo get_theme_mod('lnx_header_menu_color'); ?>;
}
.menu-item {
    border-color: <?php echo get_theme_mod('lnx_header_menu_color'); ?>;
}
...
<?php if ( get_theme_mod('lnx_footer_background_color') ) : ?>
    ...
    .request-button a:hover {
        border-color: <?php echo get_theme_mod('lnx_footer_background_color'); ?>;
    }
    #main-content h3,
    .request-button a:hover {
        color: <?php echo get_theme_mod('lnx_footer_background_color'); ?>;
    }
<?php endif; ?>
...
<?php if ( get_theme_mod('lnx_footer_font_color') ) : ?>
    ...
    .request-button a:hover {
        background-color: <?php echo get_theme_mod('lnx_footer_font_color'); ?>;
    }
<?php endif; ?>
