...
<?php
    ...
    if(get_theme_mod('lnx_company_info_address_1')) :
        $address .= get_theme_mod('lnx_company_info_address_1');
    endif;
    if(get_theme_mod('lnx_company_info_address_2')) :
        $address .= ' - ' . get_theme_mod('lnx_company_info_address_2');
    endif;
    if(get_theme_mod('lnx_company_info_city')) :
        $address .= ' ' . get_theme_mod('lnx_company_info_city');
    endif;
    if(get_theme_mod('lnx_company_info_state')) :
        $address .= ', ' . get_theme_mod('lnx_company_info_state');
    endif;
    if(get_theme_mod('lnx_company_info_zip')) :
        $address .= ' ' . get_theme_mod('lnx_company_info_zip');
    endif;
    if(get_theme_mod('lnx_company_info_latitude')) :
        $latitude .= ' ' . get_theme_mod('lnx_company_info_latitude');
    endif;
    if(get_theme_mod('lnx_company_info_longitude')) :
        $longitude .= ' ' . get_theme_mod('lnx_company_info_longitude');
    endif;
...
<footer>
    <div class="container">
        ...
        <div class="bottom">
            <div class="copyright">
                &copy; <?php echo date("Y"); ?> <?php if(get_theme_mod('lnx_footer_copyright'))  : echo get_theme_mod('lnx_footer_copyright'); endif; ?>
            </div>
