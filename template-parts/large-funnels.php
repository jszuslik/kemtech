...
$left_funnel_link = get_permalink($left_funnel_link);
...
$right_funnel_link = get_permalink($right_funnel_link);
$right_funnel_img_url = get_theme_mod('lnx_large_funnel_2_img');
?>
<section id="funnels">
    <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 funnel funnel-odd">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 funnel funnel-even">
